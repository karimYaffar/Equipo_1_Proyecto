    ...
    <form action="?C=UserController&M=Add" enctype="multipart/form-data" method="post">
      <div class="user-details">
        <div class="input-box">
          ...
          <input type="text" name="nombre" placeholder="Enter your name" required required minlength="3" maxlength="40" pattern="[a-z A-Z]+">
        </div>
        <div class="input-box">
        ...
        <div class="input-box">
          ...
          <input type="text" name="username" placeholder="Enter your Username" required required minlength="4" maxlength="18" pattern="[a-z A-Z 0-9_]+">
        </div>
        <div class="input-box">
        ...
        <div class="input-box">
          ...
          <input type="password" name="password" id="pass" placeholder="Enter your password"  required required minlength="5" maxlength="18" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}$">
        </div>
        <div class="input-box">
        ...
        <div class="input-box">
          ...
          <input type="text" name="Municipio" id="Municipio" placeholder="Town city" required minlength="3"
